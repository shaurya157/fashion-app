...
- Run using Cypress run: `npm run test:ui:run`
- Open Test Runner UI (`cypress open`): `npm run test:ui`

To run tests against emulators:

1. Start database emulators: `npm run emulators`
...
[license-image]: https://img.shields.io/github/license/shaurya157/project?style=flat-square
[license-url]: https://github.com/shaurya157/project/blob/master/LICENSE
